...
import { PREFERENCES_OPTIONS } from '@/constants/preferences';
        ...
        {currentStep === 2 && (
          <div className="min-h-[300px]">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-body-sm font-medium text-gray-700 mb-1">Username</label>
                <div className="relative">
                  <span className="absolute inset-y-0 left-3 flex items-center text-gray-500">@</span>
                  <input
                    type="text"
                    value={profileData.username}
                    onChange={(e) => onProfileChange({ ...profileData, username: e.target.value })}
                    className="w-full border border-gray-300 rounded-md py-2 pl-8 pr-3 focus:outline-none focus:ring-2 focus:ring-[#6366F1] focus:border-transparent"
