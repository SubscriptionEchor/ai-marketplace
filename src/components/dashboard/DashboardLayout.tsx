...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[#f6f6f7] flex flex-col">
        ...
        <main className="flex-1 pt-[84px] pb-[84px] bg-[#f6f6f7] overflow-y-auto scrollbar-hide lg:pt-[104px]">
          <div className="flex flex-col lg:flex-row">
            {/* Left Sidebar - Navigation */}
            <div className="w-[280px] hidden lg:block flex-shrink-0 fixed left-0 top-[84px] bottom-0 border-r border-[#e1e3e5] pt-12 bg-[#f6f6f7]">
