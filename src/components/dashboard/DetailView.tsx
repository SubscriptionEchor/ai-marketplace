...
export function DetailView() {
  ...
  // Simulate tab loading when switching tabs
  useEffect(() => {
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    <div>
                      ...
                      <div
                        ...
                        onClick={() => navigate(`/dashboard/creator/${item.creator.name}`)}
                      >
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl border border-[#e1e3e5] p-6">
                  ...
                  >
                    ...
                    <div>
                      <div className="text-sm font-medium text-gray-900 hover:text-[#0284a5] transition-colors">
                        {item.creator.name}
                      </div>
          ...
          >
            <div className="text-center py-6">
              ...
              <p className="text-gray-600 mb-6">
                Please connect your XELL wallet to make a purchase
              </p>
              <button
                onClick={() => {
                  login();
